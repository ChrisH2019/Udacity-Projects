...
class TriviaTestCase(unittest.TestCase):
    ...
    def test_retrieve_invalid_page_questions(self):
    ...
    def test_delete_question(self):
        # Insert a synthetic quetion into repostitory
        question = Question(question='new test question',
        ...
        # Retrieve the deleted synthetic quetion
        question_delete = Question.query.filter(
    ...
    def test_create_question(self):
        # Count the number of questions in the repository
        n_questions_before = len(Question.query.all())

        # Create and insert a valid question to the repository
        ...
        # Count the number of questions after the insertion
    ...
    def test_create_invalid_question(self):
        # Create and try to insert a invalid question
        res = self.client().post('/questions', json={
            'answer': 'new test answer',
            'difficulty': 4,
            'category': 2
